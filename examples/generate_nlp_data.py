...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 15:54:27 2019

@author: danielbean
"""

#generate dummy NLP output for examples
...
concepts = pd.read_csv('../output/all_concepts_to_get.csv')
all_cui = concepts['cui'].unique()
...
with open("../example_data/risk_nlp_data.txt",'w') as f:
    json.dump(output, f)